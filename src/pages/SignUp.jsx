        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            <input 
              ...
              <div className="flex justify-between whitespace-normal text-sm sm:text-lg">
                <p className="mb-6">Have a account ?
                  <Link to="/sign-in" className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-2" >Sign In</Link>
                </p>
                <p>
                  <Link to="/forgot-pass" className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out">Forgot Password ?</Link>
                </p>
              </div>
              <button 
                className="w-full bg-blue-600 text-white
                      px-7 py-3 text-sm font-medium uppercase rounded 
                      shadow-md hover:bg-blue-700 transition duration-700
